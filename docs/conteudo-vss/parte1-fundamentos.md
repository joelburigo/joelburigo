...
objetivo: |
  ...
  - Definir O QUE é o programa
  - Explicar POR QUE existe
  - Posicionar COMO se diferencia
  - Definir PARA QUEM é destinado (ICP)
...
[Início](README.md) | [Próxima Parte: Arquitetura →](parte2-arquitetura.md)

## 📑 Índice desta Parte

- [P1.1 Visão Geral do Projeto](#p11-visão-geral-do-projeto)
  - [P1.1.1 O Que é o VSS](#p111-o-que-é-o-vss)
  - [P1.1.2 Por Que Existe](#p112-por-que-existe)
- [P1.2 Posicionamento e Promessa Central](#p12-posicionamento-e-promessa-central)
  - [P1.2.1 Promessa Central](#p121-promessa-central)
  - [P1.2.2 Os 4 Pilares da Promessa](#p122-os-4-pilares-da-promessa)
  - [P1.2.3 Posicionamento de Marca](#p123-posicionamento-de-marca)
- [P1.3 Público-Alvo e Análise de Mercado](#p13-público-alvo-e-análise-de-mercado)
  - [P1.3.1 ICP (Ideal Customer Profile)](#p131-icp-ideal-customer-profile)
  - [P1.3.2 Segmentação por Categoria de Negócio](#p132-segmentação-por-categoria-de-negócio)
  - [P1.3.3 Análise de Mercado](#p133-análise-de-mercado)
- [P1.4 O Framework dos 6Ps](#p14-o-framework-dos-6ps)
  - [P1.4.1 Visão Geral dos 6Ps](#p141-visão-geral-dos-6ps)
  - [P1.4.2 Detalhamento de Cada P](#p142-detalhamento-de-cada-p)
  - [P1.4.3 Matrizes de Maturidade](#p143-matrizes-de-maturidade)
...
Este não é apenas um curso – é um programa completo de aceleração que combina metodologia proprietária, ferramentas profissionais, implementação guiada e suporte contínuo para criar transformação real no negócio.
...
**A Solução VSS:** Sistema completo implementável que funciona para qualquer MPE, independente do budget disponível para tráfego, baseado em metodologia comprovada e ferramentas profissionais incluídas.

---

## **[P1.2] POSICIONAMENTO E PROMESSA CENTRAL**

### **[P1.2.1] Promessa Central**
...
### **[P1.2.2] Os 4 Pilares da Promessa**

#### **[P1.2.2.1] PILAR 1: PRAZO REALISTA (90 DIAS)**
...
#### **[P1.2.2.2] PILAR 2: FLEXIBILIDADE TOTAL**

**O VSS se adapta à sua realidade:**
...
#### **[P1.2.2.3] PILAR 3: FERRAMENTAS PROFISSIONAIS INCLUÍDAS**
...
#### **[P1.2.2.4] PILAR 4: MÉTODO COMPROVADO (6Ps)**
...
### **[P1.2.3] Posicionamento de Marca**
...
### **[P1.3.1] ICP (Ideal Customer Profile)**
...
### **[P1.3.2] Segmentação por Categoria de Negócio**

O VSS atende empreendedores de diversos setores:
...
### **[P1.3.3] Análise de Mercado: TAM, SAM, SOM**

#### **[P1.3.3.1] TAM (Total Addressable Market): 13 Milhões**

Total de MPEs brasileiras ativas (SEBRAE/IBGE, 2023). Inclui 9,8 milhões de microempresas \+ 3,2 milhões de pequenas empresas com CNPJ ativo.

**Fonte:** SEBRAE \+ IBGE (empresas ativas no Brasil)

####

#### **[P1.3.3.2] SAM (Serviceable Available Market): ˜4 Milhões**

MPEs com faturamento de R$ 10k a 300k/mês (nosso range de atuação).
...
#### **[P1.3.3.3] SOM (Serviceable Obtainable Market):**

**Ano 1:** 300-500 alunos (\~0,01%)  
**Ano 2:** 1.000-2.000 alunos (\~0,05%)  
**Ano 3:** 5.000+ alunos (\~0,1%)

**Premissa:** Crescimento orgânico conservador sem viralização ou eventos únicos.

**Conclusão:** O mercado é gigantesco. Conquistar 0,01% no primeiro ano é ambicioso mas totalmente executável com marketing consistente.

---

## **[P1.4] O FRAMEWORK DOS 6Ps: ESPINHA DORSAL DO SISTEMA**

### **[P1.4.1] Visão Geral dos 6Ps**
...
**Cada P é um pilar. Fraqueza em um compromete todos os seguintes.**

---

### **[P1.4.2] Detalhamento de Cada P**

#### **[P1.4.2.1] P1: POSICIONAMENTO ESTRATÉGICO**
...
#### **[P1.4.2.2] P2: PÚBLICO-ALVO E SEGMENTAÇÃO**
...
#### **[P1.4.2.3] P3: PRODUTO E PROPOSTA DE VALOR**
...
#### **[P1.4.2.4] P4: PROGRAMAS DE VENDAS E TECNOLOGIA**
...
#### **[P1.4.2.5] P5: PROCESSOS ESCALÁVEIS**
...
### **[P1.4.5] Matriz de Maturidade Detalhada por P**

A seguir, a matriz completa de maturidade para cada um dos 6Ps, com descrições detalhadas e características de cada nível.
...
### **[P1.4.6] Como Priorizar Melhorias**
...
### **[P1.4.7] Plano de Ação por Nível**
...
### **[P1.4.8] Como Aplicar na Prática - 5 Passos**
