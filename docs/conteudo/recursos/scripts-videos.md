...
- [1 Script Vídeo Home](#1-script-vídeo-home)
- [2 Script Vídeo VSS](#2-script-vídeo-vss-vendas-sem-segredos)
- [3 Script Vídeo Advisory](#3-script-vídeo-advisory-strategic-advisory)
- [4 Guidelines Gerais](#4-guidelines-gerais-para-todos-os-vídeos)
- [5 Checklist de Produção](#5-checklist-de-produção)
- [6 Variações e Adaptações](#6-variações-e-adaptações)
- [7 Scripts Auxiliares](#7-scripts-auxiliares-depoimentossocial-proof)
...
- CTA (chamada de ação)
- Visual cues (o que mostrar na tela)
...
**Duração:** 3-4 minutos
**Objetivo:** Apresentar Joel Burigo, Framework 6Ps e os 2 caminhos de trabalho
**Tom:** Direto, honesto, sem firulas, inspirador
...
>
> **P3: Produto.** Sua oferta irresistível.
>
> **P4: Programas.** CRM, funis, automações — sistema que vende enquanto você dorme.
>
> **P5: Processos.** Tudo documentado. Nada na cabeça.
>
> **P6: Pessoas.** Equipe capacitada que não depende de você."

**VISUAL:** Cada P aparece com ícone e descrição curta
...
- Música de fundo sutil (instrumental, não intrusiva)
...
## 2. SCRIPT VÍDEO VSS (VENDAS SEM SEGREDOS)

**Duração:** 4-5 minutos
**Objetivo:** Vender o programa VSS (perpétuo, mentorias, CRM)
**Tom:** Educativo, transparente, inspirador
...
>
> **3. 48 mentorias ao vivo com Joel.** Semanais. 60 minutos cada. Grupo pequeno. Aprofundamento guiado dos 15 módulos. Tira dúvida, resolve trava, destrava implementação.
>
> **4. Comunidade exclusiva (90 dias).** Outros donos implementando junto. Networking. Suporte peer-to-peer.
>
> **5. Templates, scripts e recursos.** Scripts de vendas, SOPs, canvas dos 6Ps, planilhas."

**VISUAL:** Cada item com ícone ilustrativo
...
>
> **Fase 3 (Semanas 5-8):** Atração. Tráfego pago OU prospecção ativa. Leads qualificados chegando. Primeiras vendas acontecendo.
>
> **Fase 4 (Semanas 9-10):** Conversão. Funis otimizados, scripts testados, WhatsApp integrado.
>
> **Fase 5 (Semanas 11-13):** Integração. Processos documentados, métricas ativas, sistema completo funcionando."
...
- Depoimentos em texto rápido (se tiver)
...
## 3. SCRIPT VÍDEO ADVISORY (STRATEGIC ADVISORY)

**Duração:** 2-3 minutos
**Objetivo:** Vender Advisory (sessões 1:1, acesso direto)
**Tom:** Exclusivo, estratégico, direto
...
> ✅ Você valoriza sparring estratégico de alto nível
> ✅ Não precisa de execução, precisa de DIREÇÃO"
...
- Confiança absoluta
- Tom de "igual pra igual" (CEO falando com CEO)
- Menos entusiasmo, mais seriedade

---

## 4. GUIDELINES GERAIS PARA TODOS OS VÍDEOS
...
- Telas de CRM, funis, automações
- Gráficos de crescimento
- Depoimentos em texto (quando aplicável)
...
- Inspirador mas não motivacional barato
- Transparente sobre investimento e compromisso
...
- Música dramática demais
- Transições muito rápidas (respira entre ideias)
...
4. **Solução** (60-90s) - Framework/Oferta explicada
5. **Prova** (20-40s) - Cases, números, resultados
6. **Oferta** (30-60s) - O que está incluído, investimento
7. **Garantias** (20-30s) - Quando aplicável (VSS tem, Advisory não)
8. **CTA** (15-30s) - Ação clara, botão visível
...
- [ ] Script aprovado
- [ ] Locação definida e reservada
- [ ] Iluminação testada
- [ ] Câmera configurada (4K, 24fps ou 30fps)
- [ ] Microfone lapela testado
- [ ] Teleprompter configurado (se usar)
- [ ] B-roll listado e agendado
- [ ] Figurino definido (camisa social ou polo, cores neutras)

### Produção (Filmagem)

- [ ] Gravar múltiplas takes de cada seção
- [ ] Gravar B-roll adicional (sempre mais que menos)
- [ ] Capturar room tone (30s de silêncio pra edição)
- [ ] Testar áudio antes de cada take
- [ ] Backup de arquivos ao final

### Pós-Produção (Edição)

- [ ] Selecionar melhores takes
- [ ] Cortar partes desnecessárias (manter ritmo)
- [ ] Adicionar B-roll nos momentos certos
- [ ] Inserir textos/estatísticas
- [ ] Adicionar música de fundo (volume baixo, -20dB)
- [ ] Criar legendas completas
- [ ] Color grading (consistência visual)
- [ ] Exportar em múltiplos formatos (16:9, 1:1, 9:16)
- [ ] Revisão final (assistir 2x, corrigir erros)

### Pós-Publicação

- [ ] Upload otimizado (título, descrição, tags)
- [ ] Thumbnail customizado (alta conversão)
- [ ] Botões CTA clicáveis (quando aplicável)
- [ ] Compartilhar em todas as plataformas
- [ ] Monitorar métricas (taxa de retenção, conversão)

---

## 6. VARIAÇÕES E ADAPTAÇÕES
...
- 35-50s: Prova social (1 número impactante)
- 50-60s: CTA urgente
...
> [35-50s] "Caso real: R$ 160k pra R$ 1 milhão/mês em 2 anos."
> [50-60s] "R$ 1.997, acesso vitalício. Garantia 15 dias. Link abaixo."
...
- FAQ respondido (3-5 perguntas comuns)
- Bastidores (como foi criar o framework)

---

## 7. SCRIPTS AUXILIARES (DEPOIMENTOS/SOCIAL PROOF)

### Template de Depoimento em Vídeo
...
4. **Resultado:** Números concretos (antes vs depois)
5. **Depoimento:** Cliente falando sobre transformação
6. **CTA:** "Quer resultado parecido? Link na descrição"
...
- Anúncio curto (60s) → Seção 6 (Versão Curta)
- Depoimento de cliente → Seção 7
- Checklist de produção → Seção 5
...
✅ **3 scripts completos** (Home, VSS, Advisory)
✅ **Duração otimizada** (2-5 minutos cada)
✅ **Visual cues detalhados** (o que mostrar na tela)
✅ **Tom de voz específico** (como Joel deve falar)
✅ **Notas de produção** (locação, edição, música)
✅ **Guidelines gerais** (estrutura narrativa, elementos visuais)
✅ **Checklist completo** (pré, durante, pós-produção)
✅ **Variações** (60s para ads, 8-10min para YouTube)
...
2. Agendar gravação
3. Preparar B-roll
4. Editar conforme guidelines
5. Publicar e monitorar métricas

---

**Documento:** Scripts de Vídeos
**Status:** PRONTO PARA PRODUÇÃO
**Versão:** 3.0
**Última Atualização:** 2026-04-22
**Scripts Completos:** Home | VSS | Advisory
